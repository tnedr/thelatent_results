...
theorem leaf_smale6_n97 (t1 : @Real) (t2 : @Real) (h_0 : t1 < t2) (h_1 : (0 : ℝ) < t1) : (0 : ℝ) ≤ (@Real.rpow t2 ((@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)))) - (@Real.rpow t1 ((@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)))) := by sorry
