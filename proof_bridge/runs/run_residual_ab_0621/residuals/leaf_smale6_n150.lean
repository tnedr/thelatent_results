...
theorem leaf_smale6_n150 (lambda_contract : @Real) (n_iter : @Real) (h_0 : (0 : ℝ) < lambda_contract) (h_1 : lambda_contract < (@Real.ofNat 1)) (h_2 : (@Real.ofNat 1) ≤ n_iter) : (0 : ℝ) ≤ (@Real.rpow lambda_contract n_iter) := by sorry
