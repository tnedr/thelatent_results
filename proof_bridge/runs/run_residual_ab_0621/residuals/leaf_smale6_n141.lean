...
theorem leaf_smale6_n141 (diam_init : @Real) (lambda_contract : @Real) (n_iter : @Real) (h_0 : (0 : ℝ) < diam_init) (h_1 : (0 : ℝ) ≤ lambda_contract) (h_2 : lambda_contract < (@Real.ofNat 1)) (h_3 : (@Real.ofNat 1) ≤ n_iter) : (0 : ℝ) ≤ (@Real.ofNat 1) - (@Real.rpow lambda_contract n_iter) := by sorry
