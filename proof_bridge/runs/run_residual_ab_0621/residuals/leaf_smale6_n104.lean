...
theorem leaf_smale6_n104 (t : @Real) (h_0 : (0 : ℝ) < t) (h_1 : (0 : ℝ) < (@Real.rpow t ((@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)) - (@Real.ofNat 1)))) : (0 : ℝ) ≤ (@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)) * (@Real.rpow t ((@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)) - (@Real.ofNat 1))) := by sorry
