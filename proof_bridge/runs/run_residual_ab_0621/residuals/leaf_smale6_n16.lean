...
theorem leaf_smale6_n16 (delta : @Real) (kappa : @Real) (m : @Real) (h_0 : (0 : ℝ) < delta) (h_1 : (0 : ℝ) ≤ kappa) (h_2 : kappa < (@Real.ofNat 1)) (h_3 : (@Real.ofNat 1) ≤ m) : (0 : ℝ) ≤ delta * ((@Real.ofNat 1) - (@Real.rpow kappa m)) := by sorry
