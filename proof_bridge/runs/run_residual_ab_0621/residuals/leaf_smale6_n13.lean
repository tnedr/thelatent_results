...
theorem leaf_smale6_n13 (d0 : @Real) (k : @Real) (alpha : @Real) (h_0 : (0 : ℝ) < d0) (h_1 : (@Real.ofNat 1) ≤ k) (h_2 : (@Real.ofNat 1) < alpha) : (0 : ℝ) ≤ d0 * ((@Real.rpow alpha k) - (@Real.ofNat 1)) / (alpha - (@Real.ofNat 1)) - d0 * k := by sorry
