...
theorem leaf_smale6_n98 (t : @Real) (h_0 : (0 : ℝ) < t) : (0 : ℝ) ≤ (@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)) * (@Real.rpow t ((@Real.ofNat 1) / ((@Real.ofNat 222630) / (@Real.ofNat 81901)) - (@Real.ofNat 1))) := by sorry
